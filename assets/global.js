...
class ModalDialog extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.moved = true;
    if(this.closest('#CartDrawer .cart-drawer-upsell-wrap') == null) {
...
class ModalOpener extends HTMLElement {
  constructor() {
    ...
    button.addEventListener('click', () => {
      ...
      /* Start - quickview in cart drawer - JS */
      if(modal.classList.contains('cart-drawer-quickadd')){
        const cartdrawer_close = document.querySelector('.drawer__close');
        cartdrawer_close.dispatchEvent(new Event('click', {bubbles: true}));
      } 
      /* End - quickview in cart drawer - JS */
...
class SliderComponent extends HTMLElement {
  ...
  initPages() {
    ...
    if(this.classList.contains('cartdrawer-slider')){ //slider in cart drawer
...
//   const body = JSON.stringify({ discount: existingDiscount.join(','),sections: sections });
